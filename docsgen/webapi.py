...
OUTPUT_FILE: str = os.path.join(
    os.path.dirname(SCRIPT_DIR), "docs", "docsgen", "user-method.md"
)
...
def main():
    async_methods: dict = {}
    for co_fn_name, co_fn_obj in inspect.getmembers(
        web.User, inspect.iscoroutinefunction
    ):
    ...
    for fn_name, fn_obj in inspect.getmembers(
        ...
        async_method_signature: inspect.Signature = inspect.signature(
            async_methods["async_" + fn_name]
        )
