...
class Mercury(CelestialBase):
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "Extras": {},
            "Radius": 2439.7,
            "RadiusVisible": 0.00493933167,
            "RotationPeriod": 58.646225,
            "RotationPhase": 358.9865,
            "AxialTilt": 0.034,
            "Mass": 0.33022,
            "OrbitType": 0,
            "OrbitEstimation": 0,
            "Density": 5.4288210902782295,
            "Gravity": 3.7027293142758535,
            "Luminosity": 0.0,
            "Temperature": 0.0,
...
class Venus(CelestialBase):
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "OrbitType": 0,
            "OrbitEstimation": 0,
            "Density": 5.242912514272886,
            "Gravity": 8.870276983364493,
            "Luminosity": 0.0,
            "Temperature": 0.0,
            "Albedo": 0.75,
            "PowerAbsorbtion": 0.0,
...
class Earth(CelestialBase):
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "Extras": {},
            "Radius": 6378.0,
            "RadiusVisible": 0.007986238,
            "RotationPeriod": 0.9972697,
            "RotationPhase": 0.0,
            "AxialTilt": 23.44,
            "Mass": 5.9722,
            "OrbitType": 0,
            "OrbitEstimation": 0,
            "Density": 5.495309827118606,
            "Gravity": 9.798434986805644,
            "Luminosity": 0.0,
            "Temperature": 0.0,
...
class Mars(CelestialBase):
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "OrbitType": 0,
            "OrbitEstimation": 0,
            "Density": 3.9089335888549033,
            "Gravity": 3.7122212826765337,
            "Luminosity": 0.0,
            "Temperature": 0.0,
...
class Jupiter(CelestialBase):
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "OrbitType": 0,
            "OrbitEstimation": 0,
            "Density": 1.2404307437459954,
            "Gravity": 24.791909943543278,
            "Luminosity": 0.0,
            "Temperature": 0.0,
...
class Saturn(CelestialBase):
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "OrbitType": 0,
            "OrbitEstimation": 0,
            "Density": 0.6199418849015184,
            "Gravity": 10.445224444042164,
            "Luminosity": 0.0,
            "Temperature": 0.0,
...
class Uranus(CelestialBase):
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "OrbitType": 0,
            "OrbitEstimation": 0,
            "Density": 1.241222274811176,
            "Gravity": 8.868975111182902,
            "Luminosity": 0.0,
            "Temperature": 0.0,
...
class Neptune(CelestialBase):
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "OrbitType": 0,
            "OrbitEstimation": 0,
            "Density": 1.6382062699491229,
            "Gravity": 11.27643778556529,
            "Luminosity": 0.0,
            "Temperature": 0.0,
            "Albedo": 0.28999999165534973,
            "PowerAbsorbtion": 0.0,
...
class Pluto(CelestialBase):
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "OrbitType": 0,
            "OrbitEstimation": 0,
            "Density": 1.8552672808526236,
            "Gravity": 0.6161733964707342,
            "Luminosity": 0.0,
            "Temperature": 0.0,
...
class Sun(CelestialBase):
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "OrbitType": 0,
            "OrbitEstimation": 0,
            "Density": 1.408446287083086,
            "Gravity": 274.0498358435725,
            "Luminosity": 1.0,
            "Temperature": 5770.759689842919,
            "Albedo": 0.0,
            "PowerAbsorbtion": 0.0,
            "PlanetariumBalance": 0.0,
            "Position": self.position.as_postion_str_in_plsav(),
...
class BlueGiant(CelestialBase):
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "OrbitType": 0,
            "OrbitEstimation": 0,
            "Density": 0.009479092287635387,
            "Gravity": 16.84645041746542,
            "Luminosity": 427.6326424785209,
            "Temperature": 8683.093987009028,
            "Albedo": 0.0,
            "PowerAbsorbtion": 0.0,
            "PlanetariumBalance": 0.0,
            "Position": self.position.as_postion_str_in_plsav(),
...
class RedGiant(CelestialBase):
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "OrbitType": 0,
            "OrbitEstimation": 0,
            "Density": 1.4178303979424782e-06,
            "Gravity": 0.04179303383227023,
            "Luminosity": 112.28474992545416,
            "Temperature": 1526.2230364017842,
            "Albedo": 0.0,
            "PowerAbsorbtion": 0.0,
            "PlanetariumBalance": 0.0,
            "Position": self.position.as_postion_str_in_plsav(),
...
class RedDwarf(CelestialBase):
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "OrbitType": 0,
            "OrbitEstimation": 3,
            "Density": 3.976401218086238,
            "Gravity": 304.16881180896536,
            "Luminosity": 0.003987913104472093,
            "Temperature": 2312.873062778083,
            "Albedo": 0.0,
            "PowerAbsorbtion": 0.0,
            "PlanetariumBalance": 0.0,
            "Position": self.position.as_postion_str_in_plsav(),
...
class WhiteDwarf(CelestialBase):
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "OrbitType": 0,
            "OrbitEstimation": 0,
            "Density": 368261.70193835726,
            "Gravity": 820852.6402126513,
            "Luminosity": 0.02204848750849552,
            "Temperature": 20776.289920540155,
            "Albedo": 0.0,
            "PowerAbsorbtion": 0.0,
            "PlanetariumBalance": 0.0,
            "Position": self.position.as_postion_str_in_plsav(),
...
class Blackhole(CelestialBase):
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "OrbitType": 0,
            "OrbitEstimation": 0,
            "Density": 17460150441.37334,
            "Gravity": 14815027084.03691,
            "Luminosity": 0.0,
            "Temperature": 0.0,
...
class FantasyStar(CelestialBase):
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "OrbitType": 0,
            "OrbitEstimation": 3,
            "Density": 2.3866187453169605,
            "Gravity": 434.5711132851481,
            "Luminosity": 3.719063854941033,
            "Temperature": 8284.134151462116,
            "Albedo": 0.0,
            "PowerAbsorbtion": 0.0,
            "PlanetariumBalance": 0.0,
            "Position": self.position.as_postion_str_in_plsav(),
...
class Moon(CelestialBase):
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "OrbitType": 0,
            "OrbitEstimation": 3,
            "Density": 3.346481005246245,
            "Gravity": 1.625149040802321,
            "Luminosity": 0.0,
            "Temperature": 0.0,
...
class Continential(CelestialBase):
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "OrbitType": 0,
            "OrbitEstimation": 0,
            "Density": 5.353648773443054,
            "Gravity": 11.658764094408177,
            "Luminosity": 0.0,
            "Temperature": 0.0,
...
class Arctic(CelestialBase):
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "OrbitType": 0,
            "OrbitEstimation": 3,
            "Density": 5.28401556130987,
            "Gravity": 8.9606789613143,
            "Luminosity": 0.0,
            "Temperature": 0.0,
...
class Arid(CelestialBase):
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "OrbitType": 0,
            "OrbitEstimation": 3,
            "Density": 5.34256755968941,
            "Gravity": 11.703636214389228,
            "Luminosity": 0.0,
            "Temperature": 0.0,
...
class Barren(CelestialBase):
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "OrbitType": 0,
            "OrbitEstimation": 3,
            "Density": 5.192983592302659,
            "Gravity": 6.5928702184257375,
            "Luminosity": 0.0,
            "Temperature": 0.0,
...
class Desert(CelestialBase):
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "OrbitType": 0,
            "OrbitEstimation": 3,
            "Density": 5.386438443611148,
            "Gravity": 7.430477946170987,
            "Luminosity": 0.0,
            "Temperature": 0.0,
...
class Jungle(CelestialBase):
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "OrbitType": 0,
            "OrbitEstimation": 3,
            "Density": 5.2928643631051635,
            "Gravity": 4.233406517765326,
            "Luminosity": 0.0,
            "Temperature": 0.0,
...
class Toxic(CelestialBase):
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "OrbitType": 0,
            "OrbitEstimation": 3,
            "Density": 5.241213470473673,
            "Gravity": 14.334829985641749,
            "Luminosity": 0.0,
            "Temperature": 0.0,
...
class Lava(CelestialBase):
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "OrbitType": 0,
            "OrbitEstimation": 3,
            "Density": 5.3599744007793495,
            "Gravity": 8.163519931681726,
            "Luminosity": 0.0,
            "Temperature": 0.0,
...
class Ocean(CelestialBase):
    ...
    def as_dict(self) -> dict:
        return {
            ...
            "OrbitType": 0,
            "OrbitEstimation": 3,
            "Density": 5.452338182781527,
            "Gravity": 10.330477777335007,
            "Luminosity": 0.0,
            "Temperature": 0.0,
